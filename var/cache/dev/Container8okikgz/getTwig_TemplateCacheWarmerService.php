...
})))->withContext('twig.template_cache_warmer', $this), new \Symfony\Bundle\TwigBundle\TemplateIterator(${($_ = isset($this->services['kernel']) ? $this->services['kernel'] : $this->get('kernel', 1)) && false ?: '_'}, 'C:\\Monza\\app', array('C:\\Monza\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form' => NULL), 'C:\\Monza/templates'));
