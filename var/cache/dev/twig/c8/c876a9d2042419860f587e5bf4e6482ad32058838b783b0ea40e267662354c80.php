...
";
        // line 7
        echo $this->getAttribute(($context["circuit"] ?? $this->getContext($context, "circuit")), "getCircuitDescription", array());
        echo ",<img src=\"";
...
<h4>{{ circuit.getCircuitName() | raw }}</h4>

{{ circuit.getCircuitDescription | raw }},<img src=\"{{ circuit.getCircuitImage | raw }}\">
